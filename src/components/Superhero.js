              ...
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  ...
                  <Card.Text className="text-left">
                    Pencuri kecil dengan kemampuan menyusut, selamatkan dunia.
                  </Card.Text>
                  <Card.Text className="text-left">
            ...
            <Card className="movieImage">
              ...
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  ...
                  <Card.Text className="text-left">
                    Tim pahlawan bersatu untuk melawan ancaman global besar.
                  </Card.Text>
                  <Card.Text className="text-left">
            ...
            <Card className="movieImage">
              ...
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  ...
                  <Card.Text className="text-left">
                    Detektif kelam ungkap misteri kejahatan di Gotham City.
                  </Card.Text>
                  <Card.Text className="text-left">
                    Last updated 3 mins ago
                  </Card.Text>
            ...
            <Card className="movieImage">
              ...
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  ...
                  <Card.Text className="text-left">
                    Pahlawan legendaris mencuri dari yang kaya, memberi pada
                    yang miskin.
                  </Card.Text>
                  <Card.Text className="text-left">
                    Last updated 3 mins ago
            ...
            <Card className="movieImage">
              ...
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  ...
                  <Card.Text className="text-left">
                    Pemuda berkuasa laba-laba berjuang melawan kejahatan dan
                    mencari cinta.
                  </Card.Text>
                  <Card.Text className="text-left">
                    Last updated 3 mins ago
            ...
            <Card className="movieImage">
              ...
              <div className="bg-dark">
                <div className="p-2 m-1 text-white">
                  ...
                  <Card.Text className="text-left">
                    Pahlawan luar angkasa berjuang melindungi Bumi dari ancaman
                    jahat.
                  </Card.Text>
                  <Card.Text className="text-left">
                    Last updated 3 mins ago
